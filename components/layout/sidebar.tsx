...
const navigation = [
  ...
  { name: 'Projects', href: '/products', icon: Briefcase, roles: ['admin', 'manager', 'employee'] },
  { name: 'Skills', href: '/skills', icon: Award, roles: ['admin', 'manager', 'employee'] },
  { name: 'Sprints', href: '/sprints', icon: Calendar, roles: ['admin', 'manager', 'employee'] },
